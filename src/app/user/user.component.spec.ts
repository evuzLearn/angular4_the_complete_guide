...
describe('UserComponent', () => {
  ...
  it('shouldn\'t fetch data successfully if called asynchronously', async (() => {
    ...
    const app = fixture.debugElement.componentInstance;
    const dataService = fixture.debugElement.injector.get(DataService);
    const spy = spyOn(dataService, 'getDetails').and.returnValue(Promise.resolve('NewData'));
    fixture.detectChanges();
  ...
  it('shouldn\'t fetch data successfully if called asynchronously', fakeAsync (() => {
    ...
    const app = fixture.debugElement.componentInstance;
    const dataService = fixture.debugElement.injector.get(DataService);
    const spy = spyOn(dataService, 'getDetails').and.returnValue(Promise.resolve('MyData'));
    fixture.detectChanges();
    tick();
    expect(app.data).toBe('MyData');
  }));
});
